...
def plot():
    ...
    # plt.xlabel(r"$linear$")
    # plt.xlabel(r"$(a)\ linear-speadup\ β$", size=n)
    # plt.text(0.2,0.55, r'$(b)\ linear,n=50,m=16$',size=n)
    plt.text(0.22, 0.42, r"$(a)\ linear-speadup\ jobs$", size=n)
    ...
    plt.savefig("./figure/Fig.6(a).png")
    plt.show()